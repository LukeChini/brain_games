      ...
      <div class="container bg-white border col-lg-8" >
        ...
        <div class="border-top mt-3 text-center">
          ...
          if(!$_SESSION['premium_logado'])
          {
            ...
            <a href="planos.php" class="btn btn-danger mr-3 mt-2" style="-webkit-text-stroke-width: 0px;">Cancelar conta premium</a>
          </div>';
          }
          ...
          <form class="" action="../controller/tratar_cancelar_conta_premium.php" method="post">
