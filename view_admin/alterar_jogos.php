...
<html lang="en">
  <head>
    ...
    <title>Brain Games - Alterar Jogos Admin</title>
...
<form class="" enctype="multipart/form-data" action="../controller/tratar_alterar_jogos.php" method="post">
            ...
            <div class="col-12 col-lg-4" >
              <div class="card">
                ...
                <div id='divjogoMemoria1'class="border-bottom" style="overflow:hidden; height:300px">
                  ...
                  <img class="card-img-top p-3 text-center" src="<?php echo '../'.$n[ $_POST['id_jogo'] ]['src_img']; ?>"></img>
                </div>
                <div class="card-body">
...
<?php require('../include/variaveis_php_echo.php'); echo $html_footer; ?>
    ...
    <!-- Optional JavaScript -->
    <!-- jQuery first, then Popper.js, then Bootstrap JS -->g
