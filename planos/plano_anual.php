...
<?php require('../include/nav.php'); ?>
    ...
    <?php if($_SESSION['premium_logado']){header('location:inicio-logado.php');} ?>
      ...
      <div class="bg-light container" >
        ...
        <div class="col-12 col-lg-6 border mb-3 p-3 font-weight-bold" style="background-color:rgb(238,238,238); font-size:25px">Anual -
        ...
        <div class=" col-12 col-lg-6 bg-white border">
          ...
          <form action="tratar_plano_anual.php" method="post">
            ...
            <p class="ml-2 text-danger font-weight-bold" style="font-size:25px;">Você paga: R$ 59,40</p>
            ...
            <p class="ml-2">Ao adquirir, eu concordo com a assinatura recorrente para o serviço da Brain Games,
               sujeito aos <a href="#">Termos de serviço</a> e <a href="#">Política de pagamento</a>, da Brain Games,
                e os seguintes termos: Cobrança anual, R$ 59,40 por ciclo de cobrança, cobrado antecipadamente.
