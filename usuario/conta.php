      ...
      <div class="container bg-white border col-lg-8" >
        ...
        <div class="border-top mt-3">
          ...
          if(!$_SESSION['premium_logado'])
          {
            ...
            <a href="../planos/planos.php" class="btn btn-danger mr-3 mt-2" style="-webkit-text-stroke-width: 0px;">Liberar Acesso Total</a>
          </div>';
          }
        ...
        <div class="border-top ">
          ...
          <a href="alterar_email.php" class="p-3 col-lg-3 col-12 ml-3 font-weight-bold" style="font-size:15px">Alterar email</a>
          </div>

          <div class="">
          <a href="alterar_senha.php" class="p-3 col-lg-4 col-12 font-weight-bold" style="font-size:15px">Alterar senha</a>
          </div>
        </div>
              ...
              <div class="col-lg-8 col-12">
                <table class="table table-borderless">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row" colspan="2"> <a href="alterar_informacoes_pessoais.php">Alterar informações Pessoais</a> </th>
                    </tr>
                  </tbody>
                </table>
              </div>
