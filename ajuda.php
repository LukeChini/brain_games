        ...
        <div id="accordion">
          ...
          <div class="card">
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
              <div class="card-body">
                <p>Como usuário grátis você pode jogar 3 jogos por dia, desde que tenha uma conta conosco. Você pode jogar esses jogos quantas vezes quiser.
                ...
                <p>A assinatura Básica (grátis) inclui 3 jogos gratuitos como parte de sua sessão de treinamento 
          ...
          <div class="card">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
              <div class="card-body">
                <p>É só se cadastrar em um dos planos do site. Acesse a página de <a href="planos.php">planos</a></p>
              </div>
            </div>
          </div>
        </div>
